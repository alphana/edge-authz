...
//                            AccessToken.Authorization authz=new AccessToken.Authorization();
//                            authz.setPermissions(Collections.singletonList(new Permission("c55f194f-f2ee-4285-ad11-9ff7122a80fc", Set.of("GET"))));
//                            AccessToken result = JsonUtils.asAccessToken(getRawToken());
//                            result.setAuthorization(authz);
//                            return result;
//                        }
